...
import { floatingDamage } from './components/floating-damage.js'; // si decides incluirlo luego
...
export const uiModule = {
  ...
  init(core) {
    ...
    // this.components.floatingDamage = floatingDamage; // descomentar cuando lo implementes

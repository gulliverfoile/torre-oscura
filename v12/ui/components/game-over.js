...
export const gameOver = {
  ...
  mostrar(estadisticas) {
    ...
    // Pausar el juego (detener el bucle)
    if (this.core) {
  ...
  ocultar() {
    ...
    if (this.core) {
      ...
      // Reiniciar el bucle si es necesario
      if (!this.core.loop) {
        this.core.loop = requestAnimationFrame((t) => this.core.loop(t));
      }
    }
  }
};

// Función global para volver al menú (se llamará desde el botón)
